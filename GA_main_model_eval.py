...
# plot some figures
	...
	for obj in objs:
		...
		# in sample
		sns_plot = sns.lineplot(data=df, x="Generations", y="TE_insample", hue="Epoch")#, palette="inferno")
		...
		sns_plot.figure.savefig("results/GA_test/deltaT_" + str(deltaT) + "/model_eval/" + obj + str(n_sims) + "_TE_insample.png")
		sns_plot.figure.clf()
		# out of sample
		sns_plot = sns.lineplot(data=df, x="Generations", y="TE_outsample", hue="Epoch")#, palette="inferno")
		sns_plot.figure.autofmt_xdate()
		sns_plot.figure.savefig("results/GA_test/deltaT_" + str(deltaT) + "/model_eval/" + obj + str(n_sims) + "_TE_outsample.png")
		sns_plot.figure.clf()
	'''
	data_GA = dict([])
	data_GA["TE_insample"] = []
