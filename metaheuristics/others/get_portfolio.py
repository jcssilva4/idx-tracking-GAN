from metaheuristics.others.GA_torrubiano.GA_torrubiano import GA_torrubiano 
from metaheuristics.others.GA_santanna.GA_santanna import GA_santanna 
#from metaheuristics.others.GQ.GQ import GQ
#from metaheuristics.others.GQ_MiLS.GQ_MiLS import GQ_MiLS
import numpy as np

def get_solution_approx(model, selected_metaheuristic, r, k, T, num_executions, target_sol):
