...
ibovDB_use_this = pd.read_excel("data/IBOV_DB_useThis.xlsx") 
ibovDB_use_this = ibovDB_use_this.drop(ibovDB_use_this.columns[0], axis = 1)
all_tickers = ibovDB_use_this.columns[1:].to_list()
print(all_tickers)
print(len(all_tickers))
print("total number of requests: " + str(len(all_tickers)))
# filter parameters
start_date ='2010-01-12' # yyyy-mm-dd
end_date ='2021-09-08' # yyyy-mm-dd
